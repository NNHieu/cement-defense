...
class DataModule():
    ...
    def get_dataloaders(self):
        ...
        train_poisoned_dataloader = DataLoader(self.base_ds['train_poisoned'], collate_fn=collate_fn, batch_size=self.hparams.batch_size, shuffle=True, num_workers=4)
        test_poisoned_dataloader = DataLoader(self.base_ds['test_poisoned'], collate_fn=collate_fn, batch_size=self.hparams.batch_size, shuffle=False, num_workers=4)
        test_clean_dataloader = DataLoader(self.base_ds['test'], collate_fn=collate_fn, batch_size=self.hparams.batch_size, shuffle=False, num_workers=4)
